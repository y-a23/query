...
VAL_DATA="/nfsdata3/yiao/data/PaperSearchQA_verl/val_400.parquet"

TOOL_CONFIG="$CONFIG_PATH/tool_config/search_tool_config.yaml"
MODEL="/nfsdata3/yiao/yiao/model/Qwen3-4B"
trainer_project_name='queryrl_20260227'
trainer_experiment_name="qwen3-4b-papersearch_QA_no_correlation/"
CKPTS_DIR="$MODEL/ckpts/$trainer_project_name/$trainer_experiment_name"

export WANDB_RESUME=must
export WANDB_RUN_ID=20260302_run3
export QUERYRL_NOW_TEST=3
